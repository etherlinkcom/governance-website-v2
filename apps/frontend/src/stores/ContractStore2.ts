...
class ContractStore2 {
  ...
  get contractData(): ContractConfig | null {
    ...
    const baseConfig = ContractStore2.BASE_CONFIGS[this.currentContract];
    const address = ContractStore2.ADDRESSES[this.currentNetwork][this.currentContract];
...
export const contractStore2 = new ContractStore2();
export default ContractStore2;